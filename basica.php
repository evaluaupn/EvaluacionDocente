...
<p align="center"><strong>EDUCACION BÁSICA PRIMARIA MODALIDAD DISTANCIA TRADICIONAL</strong></p>
...
$docente=$row[nombre];
 echo "<option>".$docente."</option>";
	 ...
	 ?>
      ...
      <td> <div align="center"> 
          <input name="r1" type="number" id="r1" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r2" type="number" id="r2" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r3" type="number" id="r3" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r4" type="number" id="r4" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r5" type="number" id="r5" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r6" type="number" id="r6" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r7" type="number" id="r7" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td> <div align="center"> 
          <input name="r102" type="number" id="r102" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r202" type="number" id="r202" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r302" type="number" id="r302" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r402" type="number" id="r402" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r502" type="number" id="r502" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r602" type="number" id="r602" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r702" type="number" id="r702" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td> <div align="center"> 
          <input name="r103" type="number" id="r8" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><p align="center"> 
          <input name="r203" type="number" id="r9" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </p></td>
      <td> <div align="center"> 
          <input name="r303" type="number" id="r10" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r403" type="number" id="r11" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r503" type="number" id="r12" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r603" type="number" id="r13" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r703" type="number" id="r14" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td> <div align="center"> 
          <input name="r104" type="number" id="r15" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r204" type="number" id="r16" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r304" type="number" id="r17" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r404" type="number" id="r18" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r504" type="number" id="r19" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r604" type="number" id="r20" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r704" type="number" id="r21" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td> <div align="center"> 
          <input name="r105" type="number" id="r22" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r205" type="number" id="r23" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r305" type="number" id="r24" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r405" type="number" id="r25" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r505" type="number" id="r26" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r605" type="number" id="r27" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r705" type="number" id="r28" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td> <div align="center"> 
          <input name="r106" type="number" id="r29" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r206" type="number" id="r30" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r306" type="number" id="r31" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r406" type="number" id="r32" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r506" type="number" id="r33" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r606" type="number" id="r34" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r706" type="number" id="r35" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td> <div align="center"> 
          <input name="r107" type="number" id="r41" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r207" type="number" id="r42" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r307" type="number" id="r43" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r407" type="number" id="r44" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r507" type="number" id="r45" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r607" type="number" id="r46" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td> <div align="center"> 
          <input name="r707" type="number" id="r47" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r801" type="number" id="r801" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r901" type="number" id="r901" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1001" type="number" id="r1001" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1101" type="number" id="r1101" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1201" type="number" id="r1201" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1301" type="number" id="r1301" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r802" type="number" id="r48" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r902" type="number" id="r73" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1002" type="number" id="r74" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1102" type="number" id="r75" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1202" type="number" id="r76" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1302" type="number" id="r77" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r803" type="number" id="r49" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r903" type="number" id="r68" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1003" type="number" id="r69" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1103" type="number" id="r70" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1203" type="number" id="r71" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1303" type="number" id="r72" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r804" type="number" id="r50" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r904" type="number" id="r63" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1004" type="number" id="r64" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1104" type="number" id="r65" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1204" type="number" id="r66" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1304" type="number" id="r67" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r805" type="number" id="r51" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r905" type="number" id="r58" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1005" type="number" id="r59" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1105" type="number" id="r60" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1205" type="number" id="r61" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1305" type="number" id="r62" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r806" type="number" id="r52" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r906" type="number" id="r53" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1006" type="number" id="r54" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1106" type="number" id="r55" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1206" type="number" id="r56" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1306" type="number" id="r57" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
  ...
  <div align="center"> 
    <p> A1. DOCENCIA2. Trabajo de grado (BÁSICA PRIMARIA MODALIDAD DISTANCIA TRADICIONAL) Proyecto pedag&oacute;gico 
...
?>          </select>
      ...
      <td><div align="center"> 
          <input name="r1401" type="number" id="r1401" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1501" type="number" id="r1501" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1601" type="number" id="r1601" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1701" type="number" id="r1701" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r1402" type="number" id="r1402" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1502" type="number" id="r1502" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1602" type="number" id="r1602" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1702" type="number" id="r1702" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r1403" type="number" id="r1403" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1503" type="number" id="r1503" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1603" type="number" id="r1603" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1703" type="number" id="r1703" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
...
?>
      ...
      <td><div align="center"> 
          <input name="r1404" type="number" id="r1404" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1504" type="number" id="r1504" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1604" type="number" id="r1604" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
          <input name="r1704" type="number" id="r1704" placeholder="escala de 0 a 50" value="" size="5" maxlength="2">
        </div></td>
      <td><div align="center"> 
